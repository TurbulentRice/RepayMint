...
const ClosedCaret = () => <svg fill="#ffffff" width="16" height="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M11.303 8l11.394 7.997L11.303 24z"/></svg>;
  
const OpenedCaret = () => <svg fill="#ffffff" width="16" height="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M24 11.305l-7.997 11.39L8 11.305z"/></svg>;
