export default function LoanIndexItem({ loan, selectLoan, removeLoan, index }) {
  return (
    <li class="list-group-item p-2">
      ...
      <section class="d-flex justify-content-between">
        <button class="btn btn-sm btn-link p-0" onClick={() => removeLoan(index)}>
          Remove
        ...
        <button class="btn btn-sm btn-link p-0" onClick={() => selectLoan(loan)}>
          View Loan
